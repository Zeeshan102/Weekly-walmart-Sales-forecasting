...
dataset = pd.read_csv("/content/drive/MyDrive/Ahmad Project/train.csv", names=['Store','Dept','Date','weeklySales','isHoliday'],sep=',', header=0)
features = pd.read_csv("/content/drive/MyDrive/Ahmad Project/features.csv",sep=',', header=0,
                       names=['Store','Date','Temperature','Fuel_Price','MarkDown1','MarkDown2','MarkDown3','MarkDown4',
                              'MarkDown5','CPI','Unemployment','IsHoliday']).drop(columns=['IsHoliday'])
stores = pd.read_csv("/content/drive/MyDrive/Ahmad Project/stores.csv", names=['Store','Type','Size'],sep=',', header=0)
